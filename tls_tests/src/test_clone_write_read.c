 ...
 * 
 * File:   test_clone_write1_read.c
 * Author: Tony Faller
 *
 * Created on April 2, 2021, 3:10 PM
 */
...
int main(int argc, char** argv) {
    ...
    printf("Main: Trying to write one byte to cloned TLS....\n");
    ret = tls_write(0, 1, letter);
    assert(ret == 0);
